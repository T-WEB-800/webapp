...
<footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
          ...
          <p className="mt-2 text-xl text-blue-500 font-bold">TRAVELING.IO</p>
            <p className="mt-2 text-sm text-gray-500">Traveling, Made Easy.</p>
            <div className="mt-4">
          ...
          <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              <h2 className="mb-3 text-sm font-bold tracking-widest text-blue-500 uppercase title-font">About</h2>
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              <h2 className="mb-3 text-sm font-bold tracking-widest text-blue-500 uppercase title-font">Support</h2>
              <nav className="mb-10 list-none">
                <li className="mt-3">
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              <h2 className="mb-3 text-sm font-bold tracking-widest text-blue-500 uppercase title-font">Platform
              </h2>
              <nav className="mb-10 list-none">
                <li className="mt-3">
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              <h2 className="mb-3 text-sm font-bold tracking-widest text-blue-500 uppercase title-font">Contact</h2>
              <nav className="mb-10 list-none">
                <li className="mt-3">
